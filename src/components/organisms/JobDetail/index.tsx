          ...
          <div>
            ...
            <div className=" text-gray-500 mt-3">
              <p>
                ...
                Nostrum enim itaque ullam praesentium dicta deleniti eos
                repellat nam consequuntur aliquid?
              </p>
            </div>
          </div>
          <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              <PartyPopperIcon className="w-10 h-10 text-primary mb-10" />

              <div className="text-lg font-semibold mb-3">Full Health Core</div>
