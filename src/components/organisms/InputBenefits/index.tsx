...
const InputBenefit: FC<InputBenefitProps> = ({ form }) => {
  ...
  return (
    <div className="block">
      <DialogAddBenefit updateBenefits={updateBenefit} />
      <div className="grid grid-cols-3 gap-5 mt-5">
        {benefits.map((item: any, i: number) => (
          <div
            ...
            key={i}
          >
            <PartyPopper className=" w-7 h-7 mb-3 text-primary" />
            <div
