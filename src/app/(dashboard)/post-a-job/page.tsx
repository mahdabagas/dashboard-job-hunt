  ...
  const onSubmit = async (val: z.infer<typeof jobFormSchema>) => {
    try {
      const body: any = {
        ...
        requiredSkils: val.requiredSkills,
    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
          ...
          <FieldInput
            title="Who You are"
            subtitle="Add your preffers candidates qualifications"
          >
            <CKEditor
              form={form}
              name="whoYouAre"
          ...
          <FieldInput
            title="Nice-To-Haves"
            subtitle="Add nice-to-have skills and qualifications for the role to encourage a more diverse set of the candidates to apply"
          >
            <CKEditor
              form={form}
              name="niceToHaves"
